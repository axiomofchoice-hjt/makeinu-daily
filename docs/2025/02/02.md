...
description: 本期日报包含 inline 关键字对内联优化影响的话题
__tags__:
- title: '## 1. inline 对内联优化的影响'
  score: 8/10
  tags:
  - C++
  - 语法特性
  ...
  - 进阶知识
  - 编译构建和调试
  explanation: 讨论 inline 关键字在现代 C++ 中的主要作用（允许多翻译单元定义）及其对内联优化的微小影响，对比了 inlinehint 属性和
    always_inline 说明符的区别，涉及语法特性和性能优化，属于进阶知识。
---
